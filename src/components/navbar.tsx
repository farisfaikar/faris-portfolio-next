...
export default function Navbar() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 md:top-0 z-30 mx-auto my-4 flex h-full max-h-14 origin-bottom px-10">
      <div className="fixed inset-x-0 bottom-0 md:top-0 h-16 w-full bg-background to-transparent backdrop-blur-lg [-webkit-mask-image:linear-gradient(to_top,black,transparent)] md:[-webkit-mask-image:linear-gradient(to_bottom,black,transparent)] dark:bg-background"></div>
      <div className="max-w-7xl flex items-center justify-between w-full mx-auto">
        ...
        <div className="hidden md:flex items-center justify-end min-w-32">
          <Badge variant="secondary">
            <TimeDisplay />
          </Badge>
        </div>
